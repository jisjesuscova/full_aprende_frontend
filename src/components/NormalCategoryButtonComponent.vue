<template>
  <div class="md:container md:mx-auto">
    ...
    <router-link
      :to="`/content/${post.section_id}/${post.id}`"
    ...
    >
      <div class="flex flex-col w-full">
        ...
        >
          <img :src="`https://paneldecontrolaprende.cl/storage/public/files/${post.icon}`" alt="" class="h-24" />
        </div>
        <div
...
<script>
export default {
    name: 'NormalCategoryButtonComponent',
    props: {
        post: {
        type: Object,
        required: true
